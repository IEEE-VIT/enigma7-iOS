...
class RulesViewController: UIViewController {
    ...
    let rules = [
        ...
        "The second power up, Skip question (consumes 100 xp), the players can skip the current question but will not be awarded any points.",
        "The third power up (consumes 75 xp) along with a reduction of 10 points, Close answer, the players can successfully move to the next question and earn points for the question.",
